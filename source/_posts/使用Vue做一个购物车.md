...
#### 真正文
首先让我们看一下静态页面的效果图：![静态页面效果图](/images/购物车静态效果图.webp)
##### 简单说一下这个功能模块的需求：
...
![效果图，图中的图片名和路径是我编的，所以找不到](/images/效果图2_图片路径是我随便写的，所以没有图片显示.webp)
...
![问题二的现象一](/images/问题2的现象1.webp)
![问题二的现象二](/images/问题2的现象2.png)
