...
<!-- more -->
### 正文
安卓现在比较热火的四大框架应该是Rxjava，retrofit，Okhttp，Dagger。于是我去翻各种博文自己尝试着去写一个小demo。首先来看看我们这个小demo的一个效果图：![效果图.gif](https://upload-images.jianshu.io/upload_images/8654767-a6d4e7bc2e4cc4dd.gif?imageMogr2/auto-orient/strip)
...
```
其次来看看我们整个项目的一个结构图（MVP架构，直接用MVPHelper生成的）：![项目结构图](https://upload-images.jianshu.io/upload_images/8654767-fe20d0e594d25a4e.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
现在来介绍一下整个项目结构：
